...
par(mfrow=c(1,2))
hist(classBias$Mens,main="Male Employees", xlim = c(0,200000), ylim=c(0,20000), breaks=30, xlab="Men's Salaries")
hist(classBias$Womens,main="Female Employees",xlim = c(0,200000),ylim=c(0,20000), breaks=30, xlab="Women's Salaries")
```
